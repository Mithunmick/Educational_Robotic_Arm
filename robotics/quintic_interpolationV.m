function C_all = quintic_interpolationV(tin, tA, qin,vin,qdotdotin, qA, vA,qdotdotA)
    ...
    qin_dot = pinv(jacobianEE(qin)) * [vin;zeros(3,1)];
    qA_dot = pinv(jacobianEE(qA)) * [vA;zeros(3,1)];
    ...
    for i = 1:num_joints
        ...
        b = [qin(i); qin_dot(i); qdotdotin(i); qA(i); qA_dot(i); qdotdotA(i)];
